...
var Calendar = (function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderDays(classes) {
      ...
      var year = shownDate.year()
      //console.log("year",shownDate.year());
      ...
      for (var i = diff - 1; i >= 0; i--) {
        ...
        days.push({ dayMoment: dayMoment, isPassive: setIsPassive });
      }
      ...
      for (var i = 1; i <= dayCount; i++) {
        ...
        if (disableDate !== undefined) {
           for (var _i = 0; _i < disableDate.length; _i++) {
            if (disableDate[_i].diff(dayMoment, 'days') === 0 && year === disableDate[_i].year()) {
              console.log(disableDate[_i].year(),"disableDate[_i]",disableDate[_i],"dayMoment",dayMoment,"disableDate[_i].diff(dayMoment, 'days')",disableDate[_i].diff(dayMoment, 'days'))              
              setIsPassive = true;
            }
          }
        }
...
Calendar.propTypes = {
  ...
  disableDate: _react.PropTypes.array
};
