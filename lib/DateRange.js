...
var DateRange = (function (_Component) {
  ...
  function DateRange(props, context) {
    ...
    this.state = {
      ...
      defineRange: this.props.defineRange
    };
  ...
  _createClass(DateRange, [{
    ...
    value: function handleSelect(date, source) {
      var defineRange = this.props.defineRange - 1;

      var range = {
        startDate: date,
        endDate: (0, _moment2['default'])(date).add(defineRange, 'day')
      };
        ...
        (function () {
          ...
          for (var i = Number(calendars) - 1; i >= 0; i--) {
            _calendars.push(_react2['default'].createElement(_CalendarJs2['default'], {
              ...
              onlyClasses: onlyClasses,
              classNames: classes,
              disableDate: _this.props.disableDate,
